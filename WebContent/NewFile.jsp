									...
									<form class="was-validated">
										...
										<div class="form-group">
											<label for="from-year-add">Start Year</label> <input
												type="month" class="form-control" placeholder="Jul,2020"
												id="from-year-add" required>
											<div class="valid-feedback"></div>
											<div class="invalid-feedback">Please fill out this
												field.</div>
											<label for="to-year-add">End Year/Expected Year</label> <input
												type="month" class="form-control" placeholder="Jul,2024"
									...
									<form class="was-validated">
										<div class="form-group">
											<label for="cer-add">Certificate Name:</label> <input
												...
												placeholder="Ex:IBM certified Data Analyst" id="cer-add"
												required>
											<div class="valid-feedback"></div>
											<div class="invalid-feedback">Please fill out this
												field.</div>
										...
										<div class="form-group">
											<label for="org-add">Issued Organisation:</label> <input
												type="text" class="form-control" placeholder="Ex:IBM"
												id="org-add" required>
											<div class="valid-feedback"></div>
											<div class="invalid-feedback">Please fill out this
												field.</div>
									...
									<form class="was-validated">
										...
										<div class="form-group">
											<label for="worked-as-add">Worked as:</label> <input
												type="text" class="form-control"
												placeholder="Ex:Data Analyst" id="worked-as-add" required>
											<div class="valid-feedback"></div>
											<div class="invalid-feedback">Please fill out this
												field.</div>
										</div>
