...
<body>
	...
	<header class="w3-top ">
		...
		<nav class="w3-teal flex" style="padding-top: 20px;">
			...
			<label class="w3-right right-fx"> <label id="uname-1"
		...
		<div class="w3-twothird ">
			<div class="w3-card-4 w3-round-large">
				...
				<div>
					<p id="location">
						<i
							class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal w3-hover-text-deep-purple"></i><label><%=p.getCity()%>,
						<%=p.getCountry()%></label>
					</p>
				</div>
				<hr>
						...
						<%
									for(int i = 1 ;i<d.wocount((String) session.getAttribute("rmail")); i++){
										out.println("<div class=\"card-columns row w3-padding\">\r\n"
							            		...
							            		+ "									style=\"font-weight: 100; line-height: 0.2cm;\">"+wyear[i]+"</label>\r\n"
							            		+ "							</div>\r\n"
							            		+ "						</div>\r\n"
							            		+ "						<hr>");
									}
